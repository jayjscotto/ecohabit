						...
						<Grid item sm style={{ textAlign: 'center' }}>
							<Container alignItems="center" maxWidth="sm">
								<p style={{ lineHeight: '1.2', textAlign: 'center', color: 'rgb(210,209,205)' }}>
									EcoHabit is a daily diary meant to keep it's users on track to becoming a better eco
									Citizen. Designed with simplicity in mind, EcoHabit offers users an interactive and
									inuitive experience. EcoHabit is dedicated helping our users improve themselves.
									We're here daily to remind you that you are important and you choice do matter.
								</p>
							</Container>
						</Grid>
						<Grid item sm={12}>
